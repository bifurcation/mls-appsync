---
title: "A Safe Application Interface to Messaging Layer Security"
abbrev: "MLS App API"
category: info
...
group has confirmed agreement.  This document defines an interface by
...
The Messaging Layer Security protocol (MLS) {{!RFC9420}} is designed to be
integrated into applications, in order to provide security services that the
application requires.  There are two questions to answer when designing such an
integration:
...
{{?I-D.ietf-mls-architecture}}, namely the structure of the Delivery Service and
...
generated by MLS. An component identified by a ComponentID can use any HPKE
